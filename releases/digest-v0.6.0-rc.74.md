...
📦 **Since previous prerelease cut (rc73)**
  • `121214c5` fix(dashboard): drive summary counts through the tree's group engine
  • `d9532415` fix(status-bar): derive attention counts from the tree's group engine
