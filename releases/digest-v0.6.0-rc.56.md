...
📦 **Since previous prerelease cut (rc55)**
  • `60063b2f` test(agent-status): two-phase installed-VSIX proof for launcher quarantine
  • `64d5ca45` fix(agent-status): quarantine launcher tasks.json sources behind legacy opt-in
